...
func (h *locationHandlers) GetShippingCost(c *gin.Context) {
	var requestBody body.GetShippingCostRequest
	...
	resp, err := h.locationUC.GetShippingCost(c, requestBody)
	if err != nil {
	...
	response.SuccessResponse(c.Writer, resp, http.StatusOK)
}
