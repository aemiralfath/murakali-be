	...
	return []Seeder{
		...
		{Seeder: table.NewShopFaker(
			...
			[]string{"Elektronik Shop", "Pakaian Shop", "Sepatu Shop",
				...
				"Webcam Shop", "Sweater Shop", "Jaket Shop"},
			[]string{"assets/elektronik_fix.csv", "assets/pakaian_fix.csv", "assets/sepatu_fix.csv",
				"assets/tas_fix.csv", "assets/aksesoris_fix.csv", "assets/hobi_fix.csv",
				"assets/kesehatan_fix.csv", "assets/makanan_minuman_fix.csv", "assets/perawatan_fix.csv",
				"assets/dapur_fix.csv", "assets/otomotif_fix.csv", "assets/olahraga_fix.csv",
				"assets/komputer_fix.csv", "assets/hp_fix.csv", "assets/kamera_fix.csv",
				"assets/pakaian_pria_fix.csv", "assets/pakaian_wanita_fix.csv", "assets/outfit_hangat_fix.csv",
				"assets/sepatu_pria_fix.csv", "assets/sepatu_wanita_fix.csv", "assets/sepatu_anak_fix.csv",
				"assets/tas_pria_fix.csv", "assets/tas_wanita_fix.csv", "assets/kacamata_fix.csv",
				"assets/jam_tangan_fix.csv", "assets/gitar_fix.csv", "assets/buku_fix.csv",
				"assets/obat_fix.csv", "assets/masker_fix.csv", "assets/makanan_fix.csv",
				"assets/minuman_fix.csv", "assets/facewash_fix.csv", "assets/sunscreen_fix.csv",
				"assets/panci_fix.csv", "assets/kompor_fix.csv", "assets/helm_fix.csv",
				"assets/spion_fix.csv", "assets/raket_fix.csv", "assets/bola_fix.csv",
				"assets/laptop_fix.csv", "assets/mouse_fix.csv", "assets/keyboard_fix.csv",
				"assets/webcam_fix.csv", "assets/sweater_fix.csv", "assets/jaket_fix.csv"},
			[]int{2400, 2400, 2400, 2400, 2400, 2400, 2400, 2400, 2400, 2400, 2400, 2400, 2400, 2400, 2400,
